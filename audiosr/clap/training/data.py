...
def get_toy_dataset(args, model_cfg, is_train):
    raise NotImplementedError(
        "ToyDataset support is not included in this inference distribution"
    )


def get_wds_dataset(*args, **kwargs):
    raise NotImplementedError(
        "WebDataset support is not included in this inference distribution"
    )
